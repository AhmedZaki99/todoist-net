# Sync / Workspace-Filters

# Workspace Filters

*The maximum number of saved filters are dependent on the workspaces current plan.
...
| color _String_ | The color of the filter icon. Refer to the `name` column in the [Colors](022-Colors) guide for more info. |
...
| color _String_ | No | The color of the filter icon. Refer to the `name` column in the [Colors](022-Colors) guide for more info. |
