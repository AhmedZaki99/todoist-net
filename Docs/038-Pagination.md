...
The `/api/v1/activities` endpoint uses a different pagination mechanism than the cursor-based pagination described in this guide. See the [Activities documentation](034-Activity) for details on how to paginate activity log results.