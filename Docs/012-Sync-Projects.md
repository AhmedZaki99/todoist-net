...
| color _String_ | The color of the project icon. Refer to the `name` column in the [Colors](022-Colors) guide for more info. |
...
[`view_options.view_mode`](006-Sync-View-Options) for projects in Todoist
...
| color _String_ | No | The color of the project icon. Refer to the `name` column in the [Colors](022-Colors) guide for more info. |
