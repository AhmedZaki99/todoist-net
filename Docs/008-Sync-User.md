...
- `legacy`, for users that have signed up before August, 2022
  weekly_goal _Integer_ | The target number of tasks to complete per week.
...
| activity_log _Boolean_ | Whether the user can view the [activity log](034-Activity). |
...
| automatic_backups _Boolean_ | Whether [backups](035-Backups) will be automatically created for the user's account and available for download. |
| calendar_feeds _Boolean_ | Whether calendar feeds can be enabled for the user's projects. |
| comments _Boolean_ | Whether the user can add [comments](013-Sync-Comments). |
...
| email_forwarding _Boolean_ | Whether the user can add tasks or comments via [email](036-Emails). |
| filters _Boolean_ | Whether the user can add and update [filters](017-Sync-Filters). |
| max_filters _Integer_ | The maximum number of filters a user can have. |
| workspace_filters _Boolean_ | Whether the user can add and update [workspace filters](018-Sync-Workspace-Filters) (Business/Enterprise plans only). |
| max_workspace_filters _Integer_ | The maximum number of workspace filters a user can have per workspace. |
| labels _Boolean_ | Whether the user can add [labels](015-Sync-Labels). |
| max_labels _Integer_ | The maximum number of labels a user can have. |
| reminders _Boolean_ | Whether the user can add [reminders](011-Sync-Reminders). |
...
| templates _Boolean_ | Whether the user can import and export [project templates](024-Templates). |
| uploads _Boolean_ | Whether the user can [upload attachments](028-Uploads). |
| upload_limit_mb _Integer_ | The maximum size of an individual file the user can upload. |
| weekly_trends _Boolean_ | Whether the user can view [productivity stats](008-Sync-User). |
| max_projects _Integer_ | The maximum number of active [projects](012-Sync-Projects) a user can have. |
| max_sections _Integer_ | The maximum number of active [sections](010-Sync-Sections) a user can have. |
| max_tasks _Integer_ | The maximum number of active [tasks](016-Sync-Tasks) a user can have. |
| max_collaborators _Integer_ | The maximum number of [collaborators](009-Sync-Sharing) a user can add to a project. |
...
This value is indicated by the `reminders` property of the [user plan limits](008-Sync-User) object.
