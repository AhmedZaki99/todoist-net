...
`max_reminders_location` properties of the [user plan limits](008-Sync-User) object._
...
| due _Object_ | The due date of the reminder. See the [Due dates](031-Due-dates) section for more details. Note that reminders only support due dates with time, since full-day reminders don't make sense. |
...
| due _Object_ | No | The due date of the reminder. See the [Due dates](031-Due-dates) section for more details. Note that reminders only support due dates with time, since full-day reminders don't make sense. |
