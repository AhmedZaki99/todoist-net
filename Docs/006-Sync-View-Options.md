...
**Note:** `view_options.view_mode` is secondary to [`project.view_style`](006-Sync-View-Options) for projects in Todoist clients. The former is set per user, while the latter is set per project.
