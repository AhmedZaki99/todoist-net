...
| --- | --- | --- | --- |
| `client_id` | string (Client Id) | Yes | The unique Client ID of the Todoist application that you registered |
| `client_secret` | string (Client Secret) | Yes | The unique Client Secret of the Todoist application that you registered |
| `personal_token` | string (Personal Token) | Yes | Token obtained from the email/password authentication |
| `scope` | string (Scope) | Yes | Scopes of the OAuth token. Please refer to the [Authorization](002-Authorization) guide for the detailed list of available scopes. |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `access_token` | string \| null (Access Token) | Yes | Access Token (string) or Access Token (null) |
| `token_type` | string (Token Type) | Yes | Value: `"Bearer"` |
| `expires_in` | integer (Expires In) | Yes |  |
...
| `client_id` | string (Client Id) | Yes | The unique Client ID of the Todoist application that you registered |
| `client_secret` | string (Client Secret) | Yes | The unique Client Secret of the Todoist application that you registered |
| `access_token` | string (Access Token) | Yes | Access token obtained from OAuth authentication |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `token` | string (Token) | Yes | The token to be revoked (access token) |
| `token_type_hint` | string \| null (Token Type Hint) | No | A hint about the type of the token being revoked (optional). Expected value: 'access_token' |
