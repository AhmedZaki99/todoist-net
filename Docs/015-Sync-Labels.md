...
within the `labels` list of the [tasks](016-Sync-Tasks) that they are assigned to.
...
| color _String_ | The color of the label icon. Refer to the `name` column in the [Colors](022-Colors) guide for more info. |
...
| color _String_ | No | The color of the label icon. Refer to the `name` column in the [Colors](022-Colors) guide for more info. |
